# PBSpyORCA
 ...
 使用方法：  
&emsp;方法一：  
&emsp;&emsp;直接把PBSpy.dll文件改名称为PBORCxxx.dll。  
&emsp;方法二：  
&emsp;&emsp;使用PBORCA_SessionOpenWithVersion打开会话，该方法比PBORCA_SessionOpen多了一个PB版本的int类型参数。  
&emsp;&emsp;如果是PPB2.5则传入25，PB9则传入90，PB12.5传入125，PB2022传入220。  
&emsp;其它接口跟PBORCA保持一致，使用方法见PBORCA官方文档。
